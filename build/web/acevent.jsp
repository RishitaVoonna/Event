            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item active"><a class="nav-link" href="acevent.jsp">Approved</a></li>
                        <li class="nav-item"><a class="nav-link" href="index.html">Logout</a></li></ul>
                </div>
            </nav>
        </header>
							...
							<tr class="row100 head">
								...
								<th class="column100 column5" data-column="column1">Accept</th>
                                                ...
                                                <%
                                                    String pkey="no";
                                                    int id=0;
                                                    String name=null,email=(String)session.getAttribute("email"),qrcode=null,times=null,location=null,status=null;
                                                    try{
                                                    Class.forName("com.mysql.jdbc.Driver");
Connection con = DriverManager.getConnection("jdbc:mysql://localhost:3306/event", "root", "root");
String qry="select * from event where email='"+email+"'";
