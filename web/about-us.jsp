            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item"><a class="nav-link" href="about-us.jsp">Register</a></li>
                        <li class="nav-item"><a class="nav-link" href="service.html">Services</a></li>
                        <li class="nav-item"><a class="nav-link" href="AdminHome.html">Admin</a></li>
                    </ul>
                </div>
            </nav>
        </header>
                ...
                <div class="signup-content">
                    <div class="signup-form">
                        ...
                        <%
                                        ...
                                        %>
                        <form method="POST" class="register-form" id="register-form" action="signup.jsp">
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" name="email" id="email" placeholder="Your Email" onkeyup="verify(this.value);"/><font color="Green"><div id="mydiv"></div></font>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="password" name="confirm_password" id="confirm_password" placeholder="Repeat your password" onkeyup='check();'/><span id='message'></span>
                            </div>
                    ...
                    <div class="signup-image">
                        ...
                        <a href="service.html" class="signup-image-link">I am already member</a>
                    </div>
                </div>
            </div>
